...
# ✅ تعطيل استيراد الإعدادات السحابية مؤقتاً
# from cloud_config import init_cloud_settings, clean_line_display, is_cloud_environment

# ✅ تعطيل استدعاء تهيئة السحابة
# init_cloud_settings()

# تعريف دالة بسيطة مؤقتاً للتوافق
