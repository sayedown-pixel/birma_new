...
def apply_custom_css():
    ...
    /* ============================================ */
    /* تحسين السايدبار - ألوان خطوط بيضاء ساطعة */
    /* ============================================ */
    ...
    /* عنوان الراديو */
    [data-testid="stSidebar"] .stRadio > div:first-child p {
    ...
    /* تحسين النصوص في التطبيق العام */
    .stMarkdown, .stText, .stNumberInput label, .stTextInput label {
...
def show_sidebar(t):
    ...
    with st.sidebar:
        ...
        <div style="text-align: center; padding: 10px 0;">
            ...
            <h3 style="color: white; margin: 0;">Smart Factory</h3>
        ...
        if selected_page in ["📈 Production", "🔧 Maintenance", "🏠 Dashboard"]:
            st.markdown("---")
            line_options = ["الخط الأول (line 1)", "الخط الثاني (line 2)"]
            line_labels = [t.get("line1", "الخط الأول (line 1)"), t.get("line2", "الخط الثاني (line 2)")]
        ...
        st.caption(f"© {datetime.now().year} Smart Factory System")
...
def main():
    ...
    if not db_manager.is_connected():
        ...
        st.info("سيتم استخدام SQLite كقاعدة بيانات محلية. سيتم إنشاء ملف smart_factory.db تلقائياً.")
    ...
    if not selected_line:
        selected_line = "الخط الأول (line 1)"
    ...
    # Footer
    st.markdown('<div class="footer">© 2024 Smart Factory System | جميع الحقوق محفوظة</div>', unsafe_allow_html=True)
