                ...
                if not raw_ok:
                    ...
                    try:
                        ...
                        try:
                            ...
                            # ✅ إضافة تنبيهات الأرصدة الحرجة
                            from utils import get_auto_reorder_suggestions
                            critical_materials = get_auto_reorder_suggestions(df_raw, df_main)
...
{chr(10).join(critical_list)}"""
                            ...
                            # ✅ إضافة توصيات إعادة الطلب
                            from utils import get_stock_prediction_calculated
                            predictions = get_stock_prediction_calculated(df_raw, df_main, selected_line)
